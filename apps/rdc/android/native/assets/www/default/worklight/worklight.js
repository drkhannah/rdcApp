...
__WLPush = function() {
    ...
    this.__updateToken = function(notificationSubscriptionState) {
    	...
    	existingDevRegUserId = notificationSubscriptionState.userId;
        ...
        cordova.exec(function(deviceToken) {
            updateTokenCallback(serverToken, deviceToken, existingDevRegUserId, serverLoginUserId);
        }, function(errMsg) {
    ...
    function updateTokenCallback(serverToken, deviceToken, existingDevRegUserId, serverLoginUserId) {
    	var updateTokenFlowRequired = false;
    	if((typeof serverToken == "undefined") || serverToken != deviceToken) {
    		updateTokenFlowRequired = true;
    	}
    	else if(
    			((typeof existingDevRegUserId !== "undefined") && (existingDevRegUserId != serverLoginUserId)) 
    			|| 
    			((typeof existingDevRegUserId == "undefined") && (typeof serverLoginUserId !== "undefined"))
    			) {
    		updateTokenFlowRequired = true;
    	}
